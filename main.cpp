...
//meyd 402
    ...
    std::cout << "Average time for Merge Sort is " << averageTime << "micro seconds for " << size << " Batch size. " << std::endl << std::endl;
    ...
    std::cout << "Running Selection Sort Algorithm Performance" << std::endl;
    std::cout << "Time Complexity : O(N^2)" << std::endl;
    std::cout << "Space Complexity : O(1)" << std::endl;
    ...
    std::cout << "Running Quick Sort Algorithm Performance" << std::endl;
    std::cout << "Time Complexity (Best) : O(N log N)" << std::endl;
    std::cout << "Time Complexity (Worst) : O(N^2)" << std::endl;
    std::cout << "Space Complexity : O(1)" << std::endl;

    averageTime = 0;

    for (int i = 0; i < 10; i++) {
        averageTime += QuickSortPerf(arr, size, sortedArray) / 10.;
    }

    std::cout << "Average time for Quick Sort is " << averageTime << "micro seconds for " << size << " Batch size." << std::endl << std::endl;
